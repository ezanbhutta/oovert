...
import { initHeroGlass } from './modules/heroglass.js';
...
// The one moving thing in the hero, and it moves only for the pointer: a
// raymarched solid of the mark, still until you reach for it.
initHeroGlass({ reducedMotion });
